        ...
        while (true) {
            ...
            try {
                ...
                if (userInput == OPTION_ONE) {
                    ItemNameSearchView itemNameSearchView = new ItemNameSearchView(scanner);
                    itemNameSearchView.start();
                } else if (userInput == OPTION_TWO) {
                    CategoryNameSearchView categoryNameSearchView = new CategoryNameSearchView(scanner);
                    categoryNameSearchView.start();
